...
private:
    ...
    cv::Mat extractFeatures(const cv::Mat &input_img, const cv::Mat &input_superpixels, const std::size_t num_superpixels);
    ...
    static std::vector<std::vector<cv::Scalar>> returnGaborFeatures(const cv::Mat &input_img, const cv::Mat &labels, const std::size_t num_superpixels);
