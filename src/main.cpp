...
//    cv::waitKey(0);
    cv::cvtColor(input_img, input_img, cv::COLOR_GRAY2BGRA);
    cv::imwrite("/home/eshan/Hochschule/FE_Projekt_Sem1/ros_ws/src/e2r_frame_generation/data/frames_0000000020_gray.png", input_img);
     cv::Mat output_img;
     colorizer.colorizeGreyScale(input_img, output_img);
     cv::imwrite("/home/eshan/Hochschule/FE_Projekt_Sem1/ros_ws/src/e2r_frame_generation/data/frames_0000000020_colorized.png", output_img);
